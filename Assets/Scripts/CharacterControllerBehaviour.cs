...
public class CharacterControllerBehaviour : MonoBehaviour
{
    ...
    private int _verticalVelocityAnimationParameter = Animator.StringToHash("HorizontalVelocity");
    private int _horizontalVelocityAnimationParameter = Animator.StringToHash("VerticalVelocity");
